...
public class Client implements Serializable{
    ...
    public Client(int id, String name, Manager myManager, Double credits, Double payments, Double balance, Double last_month_bill, int payments_made_in_past_hour){
        this.id = id;
        this.name = name;
